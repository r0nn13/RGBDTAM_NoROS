...
loopcloser::loopcloser()
{
    ...
    sprintf (buffer,"/home/viki/catkin_ws/src/rgbtam/ThirdParty/DBoW2/ORBvoc.txt");
...
void loopcloser::print_keyframes_after_optimization()
{
    ...
    //if(use_kinect == 0)
    {
        cout<<point_cloud_keyframes_without_opt.rows<< " without opt"<<endl;
        ...
        sprintf (buffer,"/home/viki/catkin_ws/src/rgbtam/src/results_depth_maps/reconstruction_after_optimization_total.ply");
        print_point_cloud(point_cloud_keyframes_after_opt_total,buffer);
        sprintf (buffer,"/home/viki/catkin_ws/src/rgbtam/src/results_depth_maps/reconstruction_without_optimization_total.ply");
...
{
    cout<<"EVALUATION ROWS: "<<keyframes_vector.size()<<endl;
                                  ...
                                  double stamps,int size_first_level)
{
    ...
    sprintf(buffer_evaluation,"/home/viki/catkin_ws/src/rgbtam/src/evaluation/trajectory_no_posegraph.txt");
    ...
    sprintf(buffer,"/home/viki/catkin_ws/src/rgbtam/src/results_depth_maps/tracking_NO_posegraph.ply");
    ...
    //if (matchings_inliers.rows > 0)
    {
        ...
        if (R_vector.size() > 5)
        {
            ...
            char buffer_evaluation[150];
            sprintf(buffer_evaluation,"src/rgbtam/src/evaluation/trajectory_posegraph.txt");
